...
def get_provider(account: "Account") -> InvoiceProvider:
    ...
    if provider_type == 'infakt':
        ...
        return provider_class(api_key=account.infakt_api_key)

    # Przyszłe providery będą miały własne credentials
    # if provider_type == 'wfirma':
    #     return provider_class(api_key=account.wfirma_api_key, company_id=account.wfirma_company_id)
